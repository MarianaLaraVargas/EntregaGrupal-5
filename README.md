...
git clone <repo-url>
cd gym_inventory_project_improved
...
El ETL además genera backups en backups/:
...
Guarda tus capturas en docs/img/ con estos nombres para que se muestren aquí.

Toast de confirmación (Bootstrap)
<img src="Capturas\agregar.png" alt="Agregar" width="720">
...
<img src="Capturas\ETL ejecutado.png" alt="Inventario limpio actualizado tras ETL" width="720">
